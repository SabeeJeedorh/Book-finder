        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between py-3 sm:py-0 sm:h-20 gap-3 sm:gap-0">
            <div className="flex items-center justify-between w-full sm:w-auto">
              <Link href="/sections/Homepage" className="flex items-center space-x-1 sm:space-x-2 text-red-700 hover:text-red-600 transition-all duration-300 group">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8 relative z-10">
        {favorites.length === 0 ? (
          <div className="text-center py-12 sm:py-20">
            ...
            <Link href="/sections/Homepage" className="inline-flex items-center space-x-2 sm:space-x-3 bg-gradient-to-r from-red-600 to-red-500 text-white px-6 sm:px-10 py-3 sm:py-4 rounded-xl sm:rounded-2xl font-semibold hover:shadow-2xl hover:scale-105 transition-all duration-300 text-sm sm:text-base">
